...
| P2 | **L-18** 真模型资产（85 GLB 导入+注册+敌人/首领/召唤/NPC 激活+专属动效档案，[devlog 08-11](devlog/2026-08-11/01-85-glb-into-game-real-model-milestone.md)；职业身体线程化与武器握持点待续）/ **L-19** Boss 攻击 type 全覆盖 / **L-20** 弱点骨骼锚点 / **L-21** .tres 作者化 / **L-22** 精英对齐文档 | 🟡 IN PROGRESS |
