...
**See also:** [`../soulslike/design.md`](../soulslike/design.md) — 12-topic DS design audit, vertical slice checklist
**See also:** [`../soulslike/weapons.md`](../soulslike/weapons.md) — per-style weapon tuning, hit-stop, hyper armor
**See also:** [`prototype-baseline.md`](prototype-baseline.md) — original soulslike vertical slice research, Godot API mapping
...
1. **Per-style weapon data resources:** Currently, all five combat styles use uniform timing and costs. The ecosystem research strongly recommends `Resource`-based per-style differentiation (see [`../soulslike/weapons.md`](../soulslike/weapons.md) for specific tuning targets).
